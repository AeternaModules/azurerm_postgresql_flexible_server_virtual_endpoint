output "postgresql_flexible_server_virtual_endpoints_id" {
  ...
  value       = { for k, v in azurerm_postgresql_flexible_server_virtual_endpoint.postgresql_flexible_server_virtual_endpoints : k => v.id if v.id != null && length(v.id) > 0 }
}
output "postgresql_flexible_server_virtual_endpoints_name" {
  ...
  value       = { for k, v in azurerm_postgresql_flexible_server_virtual_endpoint.postgresql_flexible_server_virtual_endpoints : k => v.name if v.name != null && length(v.name) > 0 }
}
output "postgresql_flexible_server_virtual_endpoints_replica_server_id" {
  ...
  value       = { for k, v in azurerm_postgresql_flexible_server_virtual_endpoint.postgresql_flexible_server_virtual_endpoints : k => v.replica_server_id if v.replica_server_id != null && length(v.replica_server_id) > 0 }
}
output "postgresql_flexible_server_virtual_endpoints_source_server_id" {
  ...
  value       = { for k, v in azurerm_postgresql_flexible_server_virtual_endpoint.postgresql_flexible_server_virtual_endpoints : k => v.source_server_id if v.source_server_id != null && length(v.source_server_id) > 0 }
}
output "postgresql_flexible_server_virtual_endpoints_type" {
  ...
  value       = { for k, v in azurerm_postgresql_flexible_server_virtual_endpoint.postgresql_flexible_server_virtual_endpoints : k => v.type if v.type != null && length(v.type) > 0 }
}
